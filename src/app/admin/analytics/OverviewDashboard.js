...
export default function OverviewDashboard() {
    ...
    const fetchSalesData = async () => {
        ...
        try {
            ...
            const processedProducts = topProductsData.reduce((acc, sale) => {
                const existingProduct = acc.find(p => p.product_code === sale.product_code);
                if (existingProduct) {
                ...
                <CustomCardContent>
                    <ResponsiveContainer width="100%" height={400}>
                        ...
                        >
                            <CartesianGrid strokeDasharray="3 3" />
                            <XAxis type="number" />
                            <YAxis type="category" dataKey="category_name" width={150} interval={0} />
                            <Tooltip
